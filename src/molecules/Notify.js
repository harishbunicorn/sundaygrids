...
const Notify = ({children}) => {
    return (
        <div className='flex items-center justify-between bg-blue-50 border-2 border-blue-100 rounded-full py-2 px-3'>
            <p className='text-sm text-purple-primary mr-6'>New project coming soon!</p>
